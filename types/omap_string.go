// Code generated by "stringer -type=omapValFlag,omapSnapshotFlag,omapFlag,omapReapPhase -output omap_string.go"; DO NOT EDIT.
...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[OMAP_REAP_PHASE_MAP_TREE-1]
	_ = x[OMAP_REAP_PHASE_SNAPSHOT_TREE-2]
}

const _omapReapPhase_name = "OMAP_REAP_PHASE_MAP_TREEOMAP_REAP_PHASE_SNAPSHOT_TREE"
